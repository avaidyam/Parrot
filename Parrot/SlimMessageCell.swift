...
public class SlimMessageCell: NSCollectionViewItem, NSTextViewDelegate {
    ...
    private lazy var stripeLayer: CALayer = {
        let l = CALayer()
        l.backgroundColor = .ns(.red)
        return l
    }()
    ...
    public override func loadView() {
        ...
        self.view.add(sublayer: self.stripeLayer)
        self.view.add(subviews: self.photoView, self.textLabel) {
            ...
            self.stripeLayer.layout.verticalAnchors == self.view.verticalAnchors
            self.stripeLayer.layout.leftAnchor == self.photoView.rightAnchor
            self.stripeLayer.layout.rightAnchor == self.textLabel.leftAnchor
    ...
    private func setColors() {
        ...
        //if !text.string.isEmoji {
            ...
            self.stripeLayer.backgroundColor = color.cgColor
        //} else {
        //    self.stripeLayer.backgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0).cgColor
        //}
    }
